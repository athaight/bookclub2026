...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      console.log("[DEBUG] Login email:", JSON.stringify(email));
      console.log("[DEBUG] Members:", JSON.stringify(members.map(m => m.email)));
  ...
  function renderAdminCurrentBlock(memberEmail: string) {
